    ...
    <section className="py-24 relative overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <motion.div 
          ...
          className="max-w-4xl mx-auto bg-mobrand-primary rounded-[3rem] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl"
        >
          {/* Inner card graphical elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-mobrand-accent/20 rounded-full blur-[80px]" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-mobrand-teal/30 rounded-full blur-[80px]" />
          ...
          <div className="relative z-10">
             ...
             >
               <Sparkles className="w-8 h-8 text-mobrand-accent" />
             </motion.div>
