      ...
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <motion.div
            ...
            className="text-mobrand-teal font-medium uppercase tracking-wider mb-4"
          >
            How It Works
          </motion.div>
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-bold font-heading text-mobrand-primary leading-tight"
          >
            Start your journey in <br className="hidden md:block" />
             <span className="text-transparent bg-clip-text bg-gradient-to-r from-mobrand-primary to-slate-400">3 simple steps</span>
          </motion.h2>
        </div>
