...
import heroImage from '../../../assets/images/hero_superapp.png';
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-slate-600">🚀 Now live in 30+ cities across India</span>
          </motion.div>
          ...
          >
            Mobrand brings together online shopping, restaurant food delivery, and 
            10-minute quick commerce — all in one powerful app. India's smartest super-app.
          </motion.p>
